          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                Column(
                  children: <Widget>[
                  FadeInUp(duration: Duration(milliseconds: 1000), child: Text("Registration", style: TextStyle(
                    fontSize: 30,
                ...
                Column(
                  children: <Widget>[
                    FadeInUp(duration: Duration(milliseconds: 1200), child: makeInput(controller: _nameController, label: "Full Name", validator: _nameValidator)),
                    FadeInUp(
